...
const InventoryList = ({ items }) => (
    <div className="flex flex-col w-4/5 h-auto p-1 mx-auto my-8 overflow-y-auto bg-gray-300 rounded-lg shadow-lg shadow-slate-600 max-h-96 lg:max-h-72 lg:my-12 lg:ml-8 xl:mx-auto xl:max-h-96">
