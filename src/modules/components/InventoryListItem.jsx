...
const InventoryListItem = ({ item }) => (
    <div className="flex flex-wrap w-full h-24 my-0.5 rounded-lg bg-slate-300 p-1">
        <button className="flex justify-center w-16 h-full text-4xl rounded-lg bg-slate-400"><i className="self-center text-white fa-solid fa-box"></i></button>
        ...
        <button className="relative self-center w-10 h-10 mx-2 text-white border-2 rounded-full group bg-slate-400 border-slate-950">
            ...
            <div className="top-0 hidden h-full group-focus:absolute group-focus:flex right-12">
                <div className="w-10 h-10 mx-1 border-2 rounded-full border-orange-950 bg-gradient-to-r from-orange-800 to-orange-700" ><i className="fa-solid fa-pen-to-square"></i></div>
                <div className="w-10 h-10 mx-1 border-2 rounded-full border-red-950 bg-gradient-to-r from-red-500 to-red-700" ><i className="fa-solid fa-ban"></i></div>
            </div>
        </button>
    </div>
)
